...
import com.smqtt.common.core.utils.RSAUtils;
import com.smqtt.common.core.utils.SHA256Util;
...
import io.github.quickmsg.system.service.ISysPostService;
import io.github.quickmsg.system.service.ISysRoleService;
import io.github.quickmsg.system.service.ISysUserService;
...
public class SysUserController extends BaseController
{
    ...
    public R<LoginUser> info(@PathVariable("username") String username)
    {
        ...
        sysUserVo.setUserNames(permissionService.getUserNamePermission(username));
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user)
    {
        try {
            ...
            user.setAppId(SHA256Util.randompassword());
            user.setAppKey(RSAUtils.generateKeyPair().getPrivateKey());
        } catch (Exception e) {
     ...
     * 获取当前用户信息
     */
    @GetMapping("/infoByAppId/{appId}")
    public R<SysUser> infoByAppId(@PathVariable("appId") String appId)
    {
        SysUser sysUser = userService.selectUserByAppId(appId);
        if (StringUtils.isNull(sysUser))
        {
            return R.fail("用户名或密码错误");
        }
