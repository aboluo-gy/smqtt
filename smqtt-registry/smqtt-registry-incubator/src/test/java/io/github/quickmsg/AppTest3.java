...
public class AppTest3
{
    ...
    public void shouldAnswerWithTrue() throws URISyntaxException, UnknownHostException, InterruptedException {
        ...
        URI uri3 = new URI("udp://127.0.0.1:5002" );
        startupMembers.add(new RemoteGossipMember("cluster", uri3, "2"));
        URI uri = new URI("udp://" + "127.0.0.1" + ":" + 5003);
        GossipService gossipService = new GossipService("cluster", uri,   "3",null,
        ...
        sendSharedGossipDataMessage.setPayload("我來測試一下3");
        sendSharedGossipDataMessage.setKey("test3");
